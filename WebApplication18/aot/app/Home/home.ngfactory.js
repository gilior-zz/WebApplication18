...
var View_Home_Host0 = (function (_super) {
    ...
    View_Home_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._Home_0_3 = new Wrapper_Home(this.injectorGet(import8.Router, this.parentIndex), this.injector(0));
...
export var HomeNgFactory = new import7.ComponentFactory('ng-component', View_Home_Host0, import0.Home);
var styles_Home = [];
var renderType_Home = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, styles_Home, {});
export var View_Home0 = (function (_super) {
    ...
    View_Home0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_2 = import3.createRenderElement(this.renderer, parentRenderNode, 'img', new import3.InlineArray8(6, 'alt', '', 'class', 'img-responsive ugly-align', 'src', 'http://res.cloudinary.com/lior/image/upload/tba.jpg'), null);
