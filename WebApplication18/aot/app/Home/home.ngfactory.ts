...
export class View_Home0 extends import1.AppView<import0.Home> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_2 = import3.createRenderElement(this.renderer,parentRenderNode,'img',new import3.InlineArray8(6,'alt','','class','img-responsive ugly-align','src','http://res.cloudinary.com/lior/image/upload/tba.jpg'),(null as any));
