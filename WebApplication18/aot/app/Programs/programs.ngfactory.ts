...
class View_Programs1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._pipe_safeResource_0_0 = import3.pureProxy1((<View_Programs0>this.parentView)._pipe_safeResource_0.transform.bind((<View_Programs0>this.parentView)._pipe_safeResource_0));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    valUnwrapper.reset();
    const currVal_2:any = valUnwrapper.unwrap(import3.castByValue(this._pipe_safeResource_0_0,(<View_Programs0>this.parentView)._pipe_safeResource_0.transform)(this.context.$implicit.Text));
