...
var import29 = require('@angular/router/src/router');
var import30 = require('@angular/core/src/linker/ng_module_factory_loader');
var import31 = require('@angular/router/src/router_config_loader');
var import32 = require('@angular/router/src/router_state');
var import33 = require('@angular/core/src/application_tokens');
var AppRoutingModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_Router_10", {
        get: function () {
            if ((this.__Router_10 == null)) {
                (this.__Router_10 = import2.setupRouter(this.parent.get(import27.ApplicationRef), this._UrlSerializer_6, this._RouterOutletMap_7, this._Location_5, this, this._NgModuleFactoryLoader_8, this.parent.get(import19.Compiler), this._ROUTES_9, this._ROUTER_CONFIGURATION_3, this.parent.get(import28.UrlHandlingStrategy, null)));
            }
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_ROUTER_INITIALIZER_16", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_16 == null)) {
                (this.__ROUTER_INITIALIZER_16 = import2.initialRouterNavigation(this._Router_10, this.parent.get(import27.ApplicationRef), this._RouterPreloader_14, this._ROUTER_CONFIGURATION_3));
            }
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_APP_BOOTSTRAP_LISTENER_17", {
        get: function () {
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_CanDeactivateGuard_18", {
        get: function () {
            if ((this.__CanDeactivateGuard_18 == null)) {
                (this.__CanDeactivateGuard_18 = new import8.CanDeactivateGuard());
            }
            return this.__CanDeactivateGuard_18;
        },
        enumerable: true,
        configurable: true
    });
    AppRoutingModuleInjector.prototype.createInternal = function () {
        this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import29.Router, null));
    ...
    AppRoutingModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import30.NgModuleFactoryLoader)) {
            return this._NgModuleFactoryLoader_8;
        }
        if ((token === import31.ROUTES)) {
            return this._ROUTES_9;
        }
        if ((token === import29.Router)) {
            return this._Router_10;
        }
        if ((token === import32.ActivatedRoute)) {
        ...
        if ((token === import8.CanDeactivateGuard)) {
            return this._CanDeactivateGuard_18;
        }
